...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="media_form.php?id=<?php echo $user['user_id']; ?>" method="post" enctype="multipart/form-data">
            <div class="row">
                <div class="col-xl-6">
                        ...
                        <div class="panel-container">
                            ...
                            <div class="panel-content">
                                <div class="form-group">
                                    <img src="<?php $path = 'img/demo/avatars/';echo $path.$user['image'];?>" alt="" class="img-responsive" width="200">
                                </div>
