...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            <?php display_flash_message('success');//<div class="alert alert-success"> Профиль успешно обновлен.  </div>
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?php echo $user['status'];?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url(<?php $path = 'img/demo/avatars/';echo $path.$user['image'];?>); background-size: cover;"></span>
                                </span>
                                <div class="info-card-text flex-1">
                                    ...
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?php if(is_admin(get_authenticated_user()) || is_equal(get_user_by_email($user['email']), get_authenticated_user())): ?>
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="edit.php?id=<?php echo $user['user_id'];?>">
                                            <i class="fa fa-edit"></i>
                                        Редактировать</a>
                                        <a class="dropdown-item" href="security.php?id=<?php echo $user['user_id'];?>">
                                            <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                        <a class="dropdown-item" href="status.php?id=<?php echo $user['user_id'];?>">
                                            <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                        <a class="dropdown-item" href="media.php?id=<?php echo $user['user_id'];?>">
                                            <i class="fa fa-camera"></i>
                                            Загрузить аватар
                                        </a>
                                        <a href="delete_form.php?id=<?php echo $user['user_id'];?>" class="dropdown-item" onclick="return confirm('are you sure?');">
